                    ...
                    <div class="container">
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-4 d-none d-md-block">
                                <div class="text-capitalize mb-2" style="color: <?php echo $row_user_info['tertiary_color'] ?>; font-family:<?php echo $row_fonts['font_2']; ?>;">
                                    latest work
                                </div>
                                    ...
                                    while($row_load_works = mysqli_fetch_assoc($res_load_works)){
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="col-12 rounded-bottom" style="background: <?php echo $primary_color ?>; ">
                                                <span class="title_hover" onclick="window.open('<?php echo '../work/?title='.$canonical_url ?>', '_self')" style="cursor: pointer;"><?php echo $work_title ?></span>
                                            </div>
