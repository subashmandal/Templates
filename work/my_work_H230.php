                    ...
                    <div class="container">
                        <div class="row my-4">
                            <div class="col-lg-8" >
                                ...
                                <div class="my-5 pe-lg-5 pe-0" style="color:<?php echo $row_user_info['tertiary_color'] ?>!important; font-family:<?php echo $row_fonts['font_2'] ?>">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex" style="width: 100%; overflow-x: scroll; overflow-y: hidden;">
                                        ...
                                        while($row_load_works = mysqli_fetch_assoc($res_load_works)){
                                            ...
                                            ?>
                                            <div class="mx-2" style="height: 210px; cursor: pointer;" onclick="window.open('<?php echo '../my_work/?title='.$canonical_url ?>', '_self')">
                                                ...
                                                <div class="px-2" style="background: <?php echo $primary_color ?>; font-size: small;">
                                                    <span class="title_hover" onclick="window.open('<?php echo '../my_work/?title='.$canonical_url ?>', '_self')" style="cursor: pointer;"><?php echo $work_title_len ?>...</span>
                                                </div>
                            ...
                            <div class="col-lg-4 d-none d-md-block">
                                ...
                                while($row_load_works = mysqli_fetch_assoc($res_load_works)){
                                    ...
                                    $fallback_work_pic = $image['src'];
                                ?>
                                <div class="row p-2" style="cursor: pointer;" onclick="window.open('<?php echo '../my_work/?title='.$canonical_url ?>', '_self')">
