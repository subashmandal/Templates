...
<head>
    ...
    <title><?php echo $row_user_info['custom_work_name'] ?> | <?php echo $row_user_info['field_1'] ?></title>
    <!-- MDB icon -->
        ...
        <div style="overflow: hidden;">
            ...
            <div style=" background-color: <?php echo $row_user_info['background'] ?>">
                <div class="position-relative" style="min-height: 100vh;">
                    ...
                    <h1 style="color: <?php echo $row_user_info['secondary_color'] ?>; font-family:<?php echo $row_fonts['font_1']; ?>; padding-left: 10vw; padding-top: 5vh; font-size: 8vh;"><?php echo $row_work['work_title'] ?></h1>
                    <p style="color: <?php echo $row_user_info['secondary_color'] ?>; font-family:<?php echo $row_fonts['font_2']; ?>; padding-left: 10vw; padding-top: 2vh; font-size: 2vh;">Published on - <?php $originalDate = $row_work['added_date'];
