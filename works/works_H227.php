...
<div id="smooth-wrapper" style="overflow-x: hidden !important;">
    <div id="smooth-content" style="overflow-x: hidden !important;">
        ...
        <div class="container-fluid d-flex align-items-center position-relative" style="min-height:100vh;">
            <img src="img/Group 2.png" alt="group 2" class="position-absolute bottom-0 end-0 img-fluid d-none d-sm-block" style="z-index: -1;">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-mdb-ride="carousel">
                    ...
                    <div class="carousel-item active">
                        <div class="d-block">
                            <div class="d-flex justify-content-center">
                                <div class="row flex-sm-row flex-column " style="max-width: 90%;">
                                    <div class="col-lg-6 d-flex justify-content-center align-items-center works_img">
                                        <div class="img" style="background-image:url('img/works_img.png'); background-repeat: no-repeat; background-position: center; background-size: cover; height: 700px; width: 500px; -webkit-clip-path: polygon(0 0, 100% 0, 100% 90%, 0% 100%);
                    clip-path: polygon(0 0, 100% 0, 100% 90%, 0% 100%); position: absolute;"></div>
                                        <div class="bg_img" style="background-image:url('img/graphics bg.png'); background-repeat: no-repeat; background-position: center; background-size: cover; height: 800px; width: 600px;"></div>
                                    </div>
                                    <div class="col-lg-6 d-flex align-items-center justify-content-center works">
                                        <div class="my-5 content" style="width: 80%;">
                                            ...
                                            <p class="fs-4 fw-lighter mt-5" style="letter-spacing: 2px; text-align: justify; text-indent: 50px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi nam itaque sint! Eveniet doloribus enim, minima quod quos laboriosam libero. Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis doloribus enim laborum accusantium consequuntur nesciunt, vero possimus quam? Fugiat, doloremque. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quia ducimus libero tempora cum fugit commodi nisi amet ullam cupiditate reiciendis.</p>
                ...
                <div class="position-absolute top-50 start-0 ms-2">
                    <button class="carousel-control-prev" type="button" data-mdb-target="#carouselExampleControls" data-mdb-slide="prev">
                        <i class="fas fa-arrow-left text-danger fa-2x text-white rounded-9 px-4 py-1" style="background: #F44336;" aria-hidden="true"></i>
                        <span class="visually-hidden">Previous</span>
                    </button>
                </div>
                <div class="position-absolute top-50 end-0 me-2">
                    <button class="carousel-control-next" type="button" data-mdb-target="#carouselExampleControls" data-mdb-slide="next" >
                        <i class="fas fa-arrow-right text-danger fa-2x text-white rounded-9 px-4 py-1" style="background: #F44336;" aria-hidden="true"></i>
...
<script>
    ...
    gsap.from(".works_img", {x: "-30%",opacity:0});
    gsap.from(".works", {x: "30%",opacity:0});
