...
<head>
    ...
    <title>Resume | <?php echo $row_user_info['field_1'] ?></title>
    <!-- MDB icon -->
        ...
        <div style="overflow: hidden;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarRightAlignExample">
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="padding-right: 20vh; font-size: 2.4vh;">
                            <li class="nav-item px-4">
                                <a style="color:<?php echo $row_user_info['tertiary_color'] ?>; font-family: <?php echo $row_fonts['font_2'] ?>" class="nav-link active hua" aria-current="page" href="<?php echo $works_url ?>">Works</a>
                            </li>
                            <?php
                            if($row_user_info['resume_active']){?>
                                <li class="nav-item px-4">
                                    <a style="color:<?php echo $row_user_info['tertiary_color'] ?>; font-family: <?php echo $row_fonts['font_2'] ?>" class="nav-link active hua" aria-current="page" href="<?php echo $resume_url ?>">Resume</a>
                                </li>
                                <?php
                            }
                            ?>
                            ...
                            <li class="nav-item px-4">
                                <a style="color:<?php echo $row_user_info['tertiary_color'] ?>; font-family: <?php echo $row_fonts['font_2'] ?>" class="nav-link active hua" href="<?php echo $blogs_url ?>">Blogs</a>
                            </li>
                            <li class="nav-item px-4">
            ...
            <div style=" background-color: <?php echo $row_user_info['background'] ?>">
                <div class="position-relative" style="min-height: 100vh;">
                    ...
                    <br>
                    <div class="mt-4">
                        <div class="col-lg-12" style="padding-left: 10vw;">
                            <div style="color:<?php echo $row_user_info['tertiary_color'] ?>!important; font-family:<?php echo $row_fonts['font_2'] ?>">
                                <embed src="https://app.wooble.org/home/pdf_files/<?php echo $row_resume['content'] ?>#view=FitH&toolbar=0&navpanes=0&scrollbar=0" height="700px" width="80%" />
                            </div>
                        </div>
