<footer class="container text-center primary_color my-4 py-2" style="border-top:0px solid <?php echo $secondary_color ?>">
    <div class="row  flex-md-row flex-column-reverse">
    <!-- Copyright -->
    <div class="text-lg-start text-sm-center col-lg-6 primary_color my_font">
        © <?php echo date("Y") ?> Copyright:
        <span class="primary_color" ><?php echo $row_user_info['field_1']  ?></span>
        <p style="font-size: 12px">Designed using <a style="font-family: Ubuntu" target="_blank" class="primary_color fw-bold" href="https://wooble.org">Wooble</a></p>
    </div>
    <!-- Copyright -->
    <!-- Social Icons -->
                    ...
                    <center>
                        <a target="_blank" class="m-3 primary_color" href="<?php echo $link1 ?>">
                            <i style="font-size: 32px; color: <?php echo $secondary_color ?>"
                               class="fab fa-<?php echo $first ?> primary_color"></i>
                        </a>
                    </center>
                </div>
            <?php } ?>
