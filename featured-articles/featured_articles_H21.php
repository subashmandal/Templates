    ...
    <div class="flex">
        ...
        <div class="container" style="min-height: 100vh">
            ...
            <div class="row">
                <?php
                $count=0;
                $query_articles = "SELECT * FROM `articles_db` WHERE `email_id`='$userEmailID' ORDER BY `position` ASC, `date_created` DESC";
                $res_articles = mysqli_query($link, $query_articles);
                while ($row_articles = mysqli_fetch_assoc($res_articles)){
                    $blog_content = $row_articles['content'];
                    $article_title = $row_articles['article_title'];
                    $date_created = $row_articles['date_created'];
                    ...
                    <div class="col-lg-4 mt-2 mb-2" style="max-height: 320px">
                        ...
                        <a target="_blank" style="display: inline" href="<?php echo $row_articles['article_link'] ?>">
                            <div class="bg-image rounded-6" style="height: 320px;">
                                <img
                                        src="https://app.wooble.org/featured_article/image/<?php echo $row_articles['article_image'] ?>"
                                        onerror="this.onerror=null;this.src='<?php echo $row_articles['article_image'] ?>';"
                                    width="100%"
                                    height="100%"
                                ...
                                <!-- Mask -->
                                    ...
                                    <div class=" bottom-0 d-flex align-items-end h-100 text-center justify-content-center">
                                        <div align="left">
                                            <h6 class="fw-normal mb-2 p-2" style="color:<?php echo $text_color ?>; font-family:<?php echo $row_fonts['font_2'] ?>"><?php echo $article_title ?>
