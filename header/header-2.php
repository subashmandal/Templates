<nav class="navbar navbar-expand-lg navbar-light"style="background-color:<?php echo $bg_color; ?>; z-index: 100">
    ...
    <div class="container-fluid">
        ...
        >
            <i class="fas fa-bars text-light" style="color: <?php echo $text_color ?>;"></i>
        </button>
        <!-- Collapsible wrapper -->
        <div class="collapse navbar-collapse justify-content-center" id="navbarCenteredExample">
            <!-- Left links -->
            <ul class="navbar-nav mb-2 mb-lg-0" style="font-size: 2.4vh;">
                <li class="nav-item px-4">
                    <a style="color:<?php echo $text_color ?>; font-family: <?php echo $row_fonts['font_2'] ?>" class="nav-link active hua" aria-current="page" href="<?php echo $root_canonical_url ?>">Home</a>
                </li>
                <?php
