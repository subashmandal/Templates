<nav class="navbar navbar-expand-lg navbar-light"style="background-color:<?php echo $bg_color; ?>; z-index: 100;">
    ...
    <div class="container-fluid">
        ...
        >
            <i class="fas fa-bars" style="color: <?php echo $text_color ?>;"></i>
        </button>
        <!-- Collapsible wrapper -->
        <div class="collapse navbar-collapse" id="navbarLeftAlignExample">
            <!-- Left links -->
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="font-size: 2.4vh;">
                <?php
...
//                    echo $the_link;
        ...
        <!-- Collapsible wrapper -->
        <a class="navbar-brand d-none d-lg-block" style="padding-left: 20vh;" href="<?php echo $root_canonical_url ?>">
